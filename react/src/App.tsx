      ...
      <Modal className='select-image-modal' isOpen={!!imageSelector} isBlocking={false} onDismiss={() => setImageSelector(undefined)} >
        ...
        <div className='select-image-modal__paginator'>
          <div className='select-image-modal__paginator_icon'>
            <svg width="21" height="11" viewBox="0 0 21 11" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={() => slideItem !== 1 && setSlideItem(slideItem - 1)}>
          ...
          <div className='select-image-modal__paginator_icon'>
            <svg width="21" height="11" viewBox="0 0 21 11" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={() => slideItem !== selectImages2D.length && setSlideItem(slideItem + 1)}>
